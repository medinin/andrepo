...
import com.medinin.medininapp.activities.PrefManager;
import com.medinin.medininapp.activities.ActivityClinicLogin;
import com.medinin.medininapp.helpers.CountryCode;
import com.medinin.medininapp.utils.ClearFocusOnKBClose;

import java.lang.reflect.Method;

public class ActivityClinicLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestQueue = Volley.newRequestQueue(ActivityClinicLogin.this);
    ...
    public void showBottomSheetDialog() {
        View loginView = getLayoutInflater().inflate(R.layout.clinic_signup_dialog, null);
