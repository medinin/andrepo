...
public class NetworkConfig {
    ...
    public static final String RESPONSE_BODY = "com.medinin.medininapp.RESPONSE_BODY";
    public static final String BASE_URL = "http://docapi.medinin.com/api";
    public static String APP_ID = "";


    //*******************Actions*******************//
    public static final String TASK_COMPLETE = "com.medinin.medininapp.TASK_COMPLETE";
    public static final String DOWNLOAD_COMPLETE = "com.medinin.medininapp.DOWNLOAD_COMPLETE";
    public static final String LOCK_COMPLETE = "com.medinin.medininapp.LOCK_COMPLETE";
    public static final String API_CALLED_COMPLETELY = "com.medinin.medininapp.API_CALLED_COMPLETELY";
...
//    private static String _medininWebDomain = "https://www.medinin.com";
    ...
    public static String _domain_v1 = "https://api.medinin.in/v1/";
    public static String _domain_v2 = "https://api.medinin.in/v2/";
    public static String _domain_v3 = "https://api.medinin.in/v3/";
...
//    public static String SendOTP = _domain + "auth/login/get-otp";
  //  public static String CheckOTP = _domain + "auth/login/check-otp";
    ...
    public static String CheckOTP = _domain_v1 + "check-otp";
    public static String SendOTP = _domain_v1 + "get-otp";
    public static String userSignup = _domain_v1 + "user-signup";
    public static String speciality = _domain_v1 + "speciality";


    public static String addDoctor = _domain_v2 + "add-doctor";
    public static String addPatient = _domain_v1 + "add-doc-patient";
    public static String getPatient = _domain_v1 + "get-doc-patient";
    public static String getAllPatient = _domain_v1 + "get-doc-patient-list";
    public static String addAppointment = _domain_v3 + "add-appointment";
    public static String appointmentAvailability = _domain_v1 + "check-appointment-availability";
    public static String getDocAppointmentList = _domain_v1 + "get-doc-appointment";
    public static String getModuleDetails = _domain_v1 + "modules";
    public static String popularForms = _domain_v1 + "forms";
    ...
    public static int DOC_MODULE = 0;
    public static int PAT_MODULE = 1;
    public static int HOS_MODULE = 2;
    public static int LAB_MODULE = 3;
    public static int CLI_MODULE = 4;
