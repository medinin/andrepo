...
import static com.medinin.medininapp.utils.Utils.downloadFile;
...
public class Forms extends AppCompatActivity {
    ...
    private void fetchAllForms() {
        ...
        JsonObjectRequest jsonReq = new JsonObjectRequest(Request.Method.POST,
                "http://docapi.medinin.com/api/forms/search",_obj, new Response.Listener<JSONObject>() {
            @Override
...
//            allFormslist.addView(preview);
    ...
    private void fetchPopularForms() {
        ...
        JsonObjectRequest jsonReq = new JsonObjectRequest(Request.Method.GET,
                "http://docapi.medinin.com/api/forms/get/popular", _obj, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                VolleyLog.d(TAG, "Response: " + response.toString());
                progress.dismiss();
