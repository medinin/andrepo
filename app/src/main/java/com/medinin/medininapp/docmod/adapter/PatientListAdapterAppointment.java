...
public class PatientListAdapterAppointment extends RecyclerView.Adapter<PatientListAdapterAppointment.PatientListHolder> implements Filterable {
    ...
    public PatientListAdapterAppointment(Context mcontext, ArrayList<PatientList> patientLists) {
